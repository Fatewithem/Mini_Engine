...
set(MOMO_PRECOMPILE_PARAMS_IN_PATH "${CMAKE_CURRENT_SOURCE_DIR}/source/precompile/precompile.json.in")
set(MOMO_PRECOMPILE_PARAMS_PATH "${PRECOMPILE_TOOLS_PATH}/precompile.json")

# @MOMO_RUNTIME_HEADS@,@MOMO_EDITOR_HEADS@ 会被替换成引擎的头文件路径列表，告诉 MomoParser 要解析哪些头文件
configure_file(${MOMO_PRECOMPILE_PARAMS_IN_PATH} ${MOMO_PRECOMPILE_PARAMS_PATH})

#
# use wine for linux
if (CMAKE_HOST_WIN32)
    set(PRECOMPILE_PRE_EXE)
	set(PRECOMPILE_PARSER ${PRECOMPILE_TOOLS_PATH}/MomoParser.exe)
    set(sys_include "*") 
elseif(${CMAKE_HOST_SYSTEM_NAME} STREQUAL "Linux" )
    set(PRECOMPILE_PRE_EXE)
	set(PRECOMPILE_PARSER ${PRECOMPILE_TOOLS_PATH}/MomoParser)
...
### BUILDING ====================================================================================
set(PRECOMPILE_TARGET "MomoPreCompile")

# Called first time when building target 默认执行
...
COMMAND
    ${PRECOMPILE_PARSER} "${MOMO_PRECOMPILE_PARAMS_PATH}"  "${PARSER_INPUT}"  "${ENGINE_ROOT_DIR}/source" ${sys_include} "Momo" 0
### BUILDING ====================================================================================
COMMAND
