...
namespace Momo
{
    ...
    BlendStateWithClipData AnimationManager::getBlendStateWithClipData(const BlendState& blend_state)
    {
        ...
        blend_state_with_clip_data.clip_count  = blend_state.clip_count;   // 需要混合的动画片段
        blend_state_with_clip_data.blend_ratio = blend_state.blend_ratio;  // 全局混合比

        // 填充 AnimationClip 和 AnimSkelMap
