...
namespace Momo
{
    ...
    void VulkanRHI::initialize(RHIInitInfo init_info)
    {
        ...
        // https://gcc.gnu.org/onlinedocs/cpp/Common-Predefined-Macros.html
#if defined(__linux__)
        char const* vk_layer_path = MOMO_XSTR(MOMO_VK_LAYER_PATH);
        setenv("VK_LAYER_PATH", vk_layer_path, 1);
#elif defined(__MACH__)
        // https://developer.apple.com/library/archive/documentation/Porting/Conceptual/PortingUnix/compiling/compiling.html
        char const* vk_layer_path    = MOMO_XSTR(MOMO_VK_LAYER_PATH);
        char const* vk_icd_filenames = MOMO_XSTR(MOMO_VK_ICD_FILENAMES);
        setenv("VK_LAYER_PATH", vk_layer_path, 1);
...
#error Unknown Compiler
    ...
    void VulkanRHI::createInstance()
    {
        ...
        appInfo.pApplicationName   = "momo_renderer";
        appInfo.applicationVersion = VK_MAKE_VERSION(1, 0, 0);
        appInfo.pEngineName        = "Momo";
    ...
    RHISampler* VulkanRHI::getOrCreateDefaultSampler(RHIDefaultSamplerType type)
    {
        switch (type)
        {
        case Momo::Default_Sampler_Linear:
        ...
        case Momo::Default_Sampler_Nearest:
    ...
    Momo::QueueFamilyIndices VulkanRHI::findQueueFamilies(VkPhysicalDevice physicalm_device) // for device and surface
    {
    ...
    Momo::SwapChainSupportDetails VulkanRHI::querySwapChainSupport(VkPhysicalDevice physicalm_device)
    {
