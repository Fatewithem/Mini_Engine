...
namespace Momo
{
    enum class MOMO_IMAGE_TYPE : uint8_t
    {
        MOMO_IMAGE_TYPE_UNKNOWM = 0,
        MOMO_IMAGE_TYPE_2D
    };
    ...
    public:
        ...
        MOMO_IMAGE_TYPE   m_type { MOMO_IMAGE_TYPE::MOMO_IMAGE_TYPE_UNKNOWM};
...
template<>
struct std::hash<Momo::MeshSourceDesc>
{
    size_t operator()(const Momo::MeshSourceDesc& rhs) const noexcept { return rhs.getHashValue(); }
};
template<>
struct std::hash<Momo::MaterialSourceDesc>
{
    size_t operator()(const Momo::MaterialSourceDesc& rhs) const noexcept { return rhs.getHashValue(); }
};
