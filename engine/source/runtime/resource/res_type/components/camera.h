...
namespace Momo
{
    ...
    public:
        float m_vertical_offset {0.6f};  // 垂直方向上的偏移
    };
    ...
    public:
        META(Enable)
        float m_horizontal_offset {3.f};      // 水平方向上的偏移
        META(Enable)
        float      m_vertical_offset {2.5f};  // 垂直方向上的偏移
