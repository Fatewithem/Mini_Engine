...
// widen access only in this translation unit so generated accessors can touch private/protected members
...
namespace Momo
{
    namespace Reflection
    {
        ...
        TypeMeta::TypeMeta(std::string type_name) : m_type_name(type_name)
        {
            ...
            // 添加所有 type_name 对应的 FieldAccessor
            ...
            // 添加所有 type_name 对应的 MethodAccessor
        ...
        ReflectionInstance TypeMeta::newFromNameAndJson(std::string type_name, const Json& json_context)
        {
            ...
            {   
                // 取出 FuncTuple 中的下标1方法：ConstrutWithJson
        ...
        Json TypeMeta::writeByName(std::string type_name, void* instance)
        {
            ...
            if (iter != m_class_map.end())
            {   
                 // 取出 FuncTuple 中的下标2方法：WriteJsonByName
